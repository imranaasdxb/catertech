              ...
              >
                <div className="flex w-full flex-col gap-4 p-5 sm:flex-row sm:items-center sm:gap-5 md:p-6">
                  <div className="flex min-w-0 flex-1 flex-col justify-center">
                    ...
                    {service.comingSoon ? (
                      <span className="mt-4 inline-flex rounded-full border border-[#e8e4df] bg-[#faf9f7] px-4 py-2 text-[10px] font-bold uppercase tracking-[0.16em] text-body-muted">
                        Coming soon
                      </span>
                    ) : (
                      <WaterRiseCta
        ...
        <Container>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-sm leading-relaxed text-body-muted md:text-base">
              ...
              team directly. We respond to every enquiry within 10 minutes.
            </p>
